...
var NotesService = /** @class */ (function (_super) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, _super.prototype.update.call(this, this.tableName, note.Id, ['title', 'description', 'archived'], [note.title, note.description, note.archived ? 1 : 0])];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    NotesService.prototype.createNote = function (note) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _super.prototype.create.call(this, this.tableName, ['title', 'description', 'archived'], [note.title, note.description, note.archived ? 1 : 0])];
                    case 1:
                        response = _a.sent();
    ...
    NotesService.prototype.updateNote = function (note) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _super.prototype.update.call(this, this.tableName, note.Id, ['title', 'description', 'archived'], [note.title, note.description, note.archived ? 1 : 0])];
                    case 1:
                        _a.sent();
                        this.setNote(new _models_note_model__WEBPACK_IMPORTED_MODULE_3__["Note"](note));
                        return [2 /*return*/];
                }
            });
        });
...
var StorageService = /** @class */ (function () {
    function StorageService(platform, sqliteStorage) {
        this.platform = platform;
...
module.exports = __webpack_require__(/*! /Users/ahsanayaz/Desktop/Personal/videos-blogs-talks/packt/ionotes/src/main.ts */"./src/main.ts");
