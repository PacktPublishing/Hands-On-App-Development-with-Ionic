...
var PictureService = /** @class */ (function () {
    function PictureService(camera) {
        this.camera = camera;
    }
    PictureService.prototype.getPicture = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var options, imageData, base64Image, err_1;
...
var ManageNoteComponent = /** @class */ (function () {
    ...
    ManageNoteComponent.prototype.takePicture = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.pictureService.getPicture()];
                    case 1:
                        imageStr = _a.sent();
    ...
    ManageNoteComponent.prototype.formSubmit = function () {
        ...
        if (this.mode === this.manageModes.ADD) {
            params = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.noteForm.value, { imagePath: this.noteImage ? this.noteImage : '' });
        }
        else {
            params = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.note, this.noteForm.value, { imagePath: this.noteImage ? this.noteImage : '' });
        }
